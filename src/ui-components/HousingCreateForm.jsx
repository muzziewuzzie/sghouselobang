...
import { createHousing } from "../graphql/mutations";
export default function HousingCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setTenure(initialValues.Tenure);
    setLandTitle(initialValues.LandTitle);
    setStorey(initialValues.Storey);
    setUnit(initialValues.Unit);
    setBlock(initialValues.Block);
    setParking(initialValues.Parking);
    setLaunchPrice(initialValues.LaunchPrice);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createHousing.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
